...
class Card{
    ...
    showMenu(){
        ...
        this.editableDescription = new EditCardTexts(this.state.description, this.menuDescription, this, "description", "textarea");
        this.editableTitle = new EditCardTexts(this.state.text, this.menuTitle, this, "text", "input");
...
List1.addCard();
List1.cardArray[0].state.description = "Laundry work every Monday, Wednesday, and Friday.";
...
List1.addCard();
List1.cardArray[1].state.description = "Prepare breakfast meals for siblings and kids.";
List1.cardArray[1].state.comments.push("Always prepare with milk or fruit juice");
List1.input.value = ""

List1.input.value = "Wash the dishes";
List1.addCard();
List1.cardArray[2].state.description = "Clean the dishes for breakfast, lunch, and dinner.";
List1.input.value = ""

List1.input.value = "Fix faucet";
List1.addCard();
List1.cardArray[3].state.description = "Broken faucet since last week. Needs to be fixed by Friday.";
List1.input.value = ""

List1.input.value = "Iron clothes";
List1.addCard();
List1.cardArray[4].state.description = "Clothes must be ironed and prepared every morning for office work.";
List1.input.value = ""

List2.input.value = "Prepare materials for project";
List2.addCard();
List2.cardArray[0].state.description = "Materials for the project must be complete by Sunday next week.";
...
List2.addCard();
List2.cardArray[1].state.description = "Start to delegate tasks to every member. Distribution of work must be balanced.";
List2.input.value = ""
